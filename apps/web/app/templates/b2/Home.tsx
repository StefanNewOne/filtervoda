      ...
      <section className="mx-auto max-w-[1200px] px-5 pb-[100px] pt-[90px]">
        <div className="grid gap-11 rounded-[34px] border border-[#D9E9FB] p-12 md:grid-cols-2 [background:linear-gradient(165deg,#F2F8FF,#DFEFFC)]">
          <div>
            ...
            <a href={`tel:${phone}`} className="mt-5 inline-block font-[family-name:Oswald] text-[22px] font-medium text-[#08182F]">{phone}</a>
          </div>
        ...
        {faq.length > 0 && (
          <div className="mx-auto mt-16 max-w-2xl divide-y divide-[#E4EDF9]">
            <h2 className="mb-4 font-[family-name:Oswald] text-[clamp(26px,2.8vw,38px)] font-medium text-[#08182F]">Често поставувани прашања</h2>
            {faq.map((f, i) => (
